...
import NotifyIcon from '../images/nio.webp'
...
export default function NotifyModal() {
    ...
    return (
        <div style={{minWidth: '280px'}}>
            <div className="d-flex justify-content-between align-align-items-center px-3">
                <h3>Notifications</h3>
            ...
            <hr className="mt-0" />
            {
                ...
                <img src={NotifyIcon} alt="NoNotice" className="w-100" />
            }
